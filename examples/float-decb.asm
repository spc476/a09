...
;***************************************************************************
	...
	;-------------------------------------------------------------------
		...
		.float	99999999.9	; $9B $3E $BC $1F $FD
		.float	999999999	; $9E $6E $6B $27 $FD
		.float	1E+09		; $9E $6E $6B $28 $00
	...
	;---------------------------------
		...
		.float	(2/7)*(1/0.69314718055)
		.float	(2/5)*(1/0.69314718055)
		.float	(2/3)*(1/0.69314718055)
		.float	(2/1)*(1/0.69314718055)
		.float	2 / 2**0.5
		.float	2**0.5
		.float	-0.5
		.float	0.69314718055
	...
	;---------------------------------
		...
		.float	1.442695041000000
		.float	1/(7! * 1.442695041000000 ** 7)
		.float	1/(6! * 1.442695041000000 ** 6)
		.float	1/(5! * 1.442695041000000 ** 5)
		.float	1/(4! * 1.442695041000000 ** 4)
		.float	1/(3! * 1.442695041000000 ** 3)
		.float	1/(2! * 1.442695041000000 ** 2)
		.float	1/(1! * 1.442695041000000 ** 1)

	;---------------------------------
	; Misc. constants from ECB 1.1
	;---------------------------------

		.float	3.1415926535 / 2; $81 $49 $0F $DA $A2 (@ $843B)

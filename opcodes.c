...
static bool pseudo__opt(struct opcdata *opd)
{
  ...
  else if ((tmp.len == 4) && (memcmp(tmp.text,"REAL",4) == 0))
  {
    ...
    if ((tmp.len == 4) && (memcmp(tmp.text,"IEEE",4) == 0))
      set_ieee(&opd->a09->format,opd->a09,opd->pass);
    else if ((tmp.len == 4) && (memcmp(tmp.text,"MSFP",4) == 0))
      set_msfp(&opd->a09->format,opd->a09,opd->pass);
    else if ((tmp.len == 4) && (memcmp(tmp.text,"LBFP",4) == 0))
      set_lbfp(&opd->a09->format,opd->a09,opd->pass);
    else
...
static bool pseudo__float(struct opcdata *opd)
{
  ...
  return opd->a09->format.Float(&opd->a09->format,opd);
}
...
bool parse_op(struct buffer *buffer,struct opcode const **pop)
{
  static struct opcode const opcodes[] =
  {
    ...
    { "ASRA"    , "?aa-a" , op_inh         ,  2 , 0x47 , 0x00 , BYTE  } ,
    { "ASRB"    , "?aa-a" , op_inh         ,  2 , 0x57 , 0x00 , BYTE  } ,
    { "BCC"     , "-----" , op_br          ,  3 , 0x24 , 0x00 , BYTE  } ,
    { "BCS"     , "-----" , op_br          ,  3 , 0x25 , 0x00 , BYTE  } ,
    { "BEQ"     , "-----" , op_br          ,  3 , 0x27 , 0x00 , BYTE  } ,
    { "BGE"     , "-----" , op_br          ,  3 , 0x2C , 0x00 , BYTE  } ,
    { "BGT"     , "-----" , op_br          ,  3 , 0x2E , 0x00 , BYTE  } ,
    { "BHI"     , "-----" , op_br          ,  3 , 0x22 , 0x00 , BYTE  } ,
    { "BHS"     , "-----" , op_br          ,  3 , 0x24 , 0x00 , BYTE  } ,
    { "BITA"    , "-aa0-" , op_idie        ,  2 , 0x85 , 0x00 , BYTE  } ,
    { "BITB"    , "-aa0-" , op_idie        ,  2 , 0xC5 , 0x00 , BYTE  } ,
    { "BLE"     , "-----" , op_br          ,  3 , 0x2F , 0x00 , BYTE  } ,
    { "BLO"     , "-----" , op_br          ,  3 , 0x25 , 0x00 , BYTE  } ,
    { "BLS"     , "-----" , op_br          ,  3 , 0x23 , 0x00 , BYTE  } ,
    { "BLT"     , "-----" , op_br          ,  3 , 0x2D , 0x00 , BYTE  } ,
    { "BMI"     , "-----" , op_br          ,  3 , 0x2B , 0x00 , BYTE  } ,
    { "BNE"     , "-----" , op_br          ,  3 , 0x26 , 0x00 , BYTE  } ,
    ...
    { "CLRA"    , "-0100" , op_inh         ,  2 , 0x4F , 0x00 , BYTE  } ,
    { "CLRB"    , "-0100" , op_inh         ,  2 , 0x5F , 0x00 , BYTE  } ,
    { "CMPA"    , "?aaaa" , op_idie        ,  2 , 0x81 , 0x00 , BYTE  } ,
    { "CMPB"    , "?aaaa" , op_idie        ,  2 , 0xC1 , 0x00 , BYTE  } ,
    { "CMPD"    , "-aaaa" , op_idie        ,  5 , 0x83 , 0x10 , WORD  } ,
    { "CMPS"    , "-aaaa" , op_idie        ,  5 , 0x8C , 0x11 , WORD  } ,
    { "CMPU"    , "-aaaa" , op_idie        ,  5 , 0x83 , 0x11 , WORD  } ,
    { "CMPX"    , "-aaaa" , op_idie        ,  4 , 0x8C , 0x00 , WORD  } ,
    { "CMPY"    , "-aaaa" , op_idie        ,  5 , 0x8C , 0x10 , WORD  } ,
    { "COM"     , "-aa01" , op_die         ,  4 , 0x03 , 0x00 , BYTE  } ,
    { "COMA"    , "-aa01" , op_inh         ,  2 , 0x43 , 0x00 , BYTE  } ,
    { "COMB"    , "-aa01" , op_inh         ,  2 , 0x53 , 0x00 , BYTE  } ,
    { "CWAI"    , "?????" , op_andcc       , 20 , 0x3C , 0x00 , BYTE  } ,
    { "DAA"     , "-aa0a" , op_inh         ,  2 , 0x19 , 0x00 , BYTE  } ,
    ...
    { "EXG"     , "-----" , op_exg         ,  8 , 0x1E , 0x00 , BYTE  } ,
    { "EXTDP"   , ""      , pseudo_extdp   ,  0 , 0x00 , 0x00 , false } ,
    ...
    { "LBGE"    , "-----" , op_lbr         ,  5 , 0x2C , 0x10 , WORD  } ,
    { "LBGT"    , "-----" , op_lbr         ,  5 , 0x2E , 0x10 , WORD  } ,
    { "LBHI"    , "-----" , op_lbr         ,  5 , 0x22 , 0x10 , WORD  } ,
    { "LBHS"    , "-----" , op_lbr         ,  5 , 0x24 , 0x10 , WORD  } ,
    { "LBLE"    , "-----" , op_lbr         ,  5 , 0x2F , 0x10 , WORD  } ,
    { "LBLO"    , "-----" , op_lbr         ,  5 , 0x25 , 0x10 , WORD  } ,
    { "LBLS"    , "-----" , op_lbr         ,  5 , 0x23 , 0x10 , WORD  } ,
    { "LBLT"    , "-----" , op_lbr         ,  5 , 0x2D , 0x10 , WORD  } ,
    { "LBMI"    , "-----" , op_lbr         ,  5 , 0x2B , 0x10 , WORD  } ,
    { "LBNE"    , "-----" , op_lbr         ,  5 , 0x26 , 0x10 , WORD  } ,
    ...
    { "LDB"     , "-aa0-" , op_idie        ,  2 , 0xC6 , 0x00 , BYTE  } ,
    { "LDD"     , "-aa0-" , op_idie        ,  3 , 0xCC , 0x00 , WORD  } ,
    { "LDS"     , "-aa0-" , op_idie        ,  4 , 0xCE , 0x10 , WORD  } ,
    ...
    { "LSR"     , "-0a-a" , op_die         ,  4 , 0x04 , 0x00 , BYTE  } ,
    { "LSRA"    , "-0a-a" , op_inh         ,  2 , 0x44 , 0x00 , BYTE  } ,
    { "LSRB"    , "-0a-a" , op_inh         ,  2 , 0x54 , 0x00 , BYTE  } ,
    { "MUL"     , "--a-a" , op_inh         , 11 , 0x3D , 0x00 , BYTE  } ,
    { "NEG"     , "?aaaa" , op_die         ,  4 , 0x00 , 0x00 , BYTE  } ,
    { "NEGA"    , "?aaaa" , op_inh         ,  2 , 0x40 , 0x00 , BYTE  } ,
    { "NEGB"    , "?aaaa" , op_inh         ,  2 , 0x50 , 0x00 , BYTE  } ,
    { "NOP"     , "-----" , op_inh         ,  2 , 0x12 , 0x00 , BYTE  } ,
    { "ORA"     , "0aa0-" , op_idie        ,  2 , 0x8A , 0x00 , BYTE  } ,
    ...
    { "PULS"    , "-----" , op_pshpul      ,  5 , 0x35 , 0x00 , BYTE  } ,
    { "PULU"    , "-----" , op_pshpul      ,  5 , 0x37 , 0x00 , BYTE  } ,
    { "RMB"     , ""      , pseudo_rmb     ,  0 , 0x00 , 0x00 , false } ,
    { "ROL"     , "-aaaa" , op_die         ,  4 , 0x09 , 0x00 , BYTE  } ,
    { "ROLA"    , "-aaaa" , op_inh         ,  2 , 0x49 , 0x00 , BYTE  } ,
    { "ROLB"    , "-aaaa" , op_inh         ,  2 , 0x59 , 0x00 , BYTE  } ,
    ...
    { "SWI"     , "-----" , op_inh         , 19 , 0x3F , 0x00 , BYTE  } ,
    { "SWI2"    , "-----" , op_inh         , 20 , 0x3F , 0x10 , BYTE  } ,

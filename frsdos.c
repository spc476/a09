...
char const format_rsdos_usage[] =
        ...
        OC "B file\t\tfilename for BASIC code output\n"
        OC "E\t\tinclude EXEC call\n"
        OC "L line\t\tstarting line # (default 10)\n"
        OC "N file\t\tfilename for RSDOS\n"
...
static bool frsdos_cmdline(struct format *fmt,struct a09 *a09,struct arg *arg,char c)
{
  ...
  switch(c)
  {
    case 'B':
         ...
         {
           fprintf(stderr,OPT "B: missing file name\n");
           return false;
         }
         break;
    ...
    case 'L':
         ...
         {
           fprintf(stderr,OPT "L: line number must be between 1 and 63999\n");
           return false;
         }
         break;
    ...
    case 'N':
         ...
         {
           fprintf(stderr,OPT "N: missing file name\n");
           return false;
         }
         break;
    ...
    case 'P':
         ...
         {
           fprintf(stderr,OPT "P: string space must be between 0 and 22528\n");
           return false;
         }
         break;

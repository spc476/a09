...
extern bool                  set_ieee           (struct format *,struct a09 *,int);
extern bool                  set_msfp           (struct format *,struct a09 *,int);
extern bool                  set_lbfp           (struct format *,struct a09 *,int);
...
extern bool                  test_run           (struct a09 *);
